...
- [Plugin 能力规划草案](./plugin-capability-plan.md)
- [Plugin 端到端流程说明](./plugin-end-to-end-flow.md)
- [Plugin Runtime 架构](./03-runtime-architecture.md)
- [MCP / OpenAPI 接入策略](./04-mcp-openapi-strategy.md)
- [开源项目参考与复用策略](./06-open-source-reference-and-reuse.md)
- [0-1 开发计划与粗估](./07-development-plan-and-estimation.md)
- [POC 验收说明与后续 Roadmap](../plugin-poc/poc-acceptance-and-roadmap.md)
- [POC 代码分层与部署映射](../plugin-poc/code-structure-and-deployment-mapping.md)
