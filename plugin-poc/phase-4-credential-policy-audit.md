...
| 文件 | 作用 |
| --- | --- |
| `plugin_poc/credentials.py` | POC Credential Broker，配置、查询、测试 credential |
| `plugin_poc/policy.py` | POC Policy Engine，检查 credential 是否存在和 sensitive action 是否确认 |
| `plugin_poc/audit.py` | 本地 audit log，记录每次 invoke 尝试 |
